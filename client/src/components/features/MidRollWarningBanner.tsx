// client/src/components/features/MidRollWarningBanner.tsx
// 10-second warning banner before mid-roll ad - inline version
import { useState, useEffect } from 'react';
import { motion } from 'framer-motion';
import Icon from '../ui/Icon';

interface MidRollWarningBannerProps {
  secondsRemaining: number;
  onWarningEnd: () => void;
}

export function MidRollWarningBanner({ secondsRemaining, onWarningEnd }: MidRollWarningBannerProps) {
